...
public class StatsClient extends BaseClient {
    ...
    public ResponseEntity<Object> getStats(String start,
        ...
        log.debug("+StatsClient - getStats: start = {}, end = {}, unique = {}, uris = {}", start, end, unique, uris);

        ResponseEntity<Object> answer;
        if (uris != null) {
            parameters.put("uris", uris);
            log.debug("+StatsClient - getStats, uris != null: start = {}, end = {}, unique = {}, uris = {}", start, end, unique, uris);
        ...
        log.debug("-StatsClient - getStats: answer = {}", answer);
        return answer;
    }
